...
public class SLBatchRequest
{
    ...
    ///     By default it is configured so the <see cref="System.Text.Json.JsonSerializerOptions.DefaultIgnoreCondition" /> is set to <see cref="JsonIgnoreCondition.WhenWritingNull" />.
    /// </summary>
