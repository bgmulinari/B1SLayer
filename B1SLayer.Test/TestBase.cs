...
public abstract class TestBase : IDisposable
{
    ...
    protected static SLConnection SLConnectionV1 { get; } = new("https://sapserver:50000/b1s/v1", "CompanyDB", "manager", "12345");
    protected static SLConnection SLConnectionV2 { get; } = new("https://sapserver:50000/b1s/v2", "CompanyDB", "manager", "12345");
    ...
    {
        yield return new[] { SLConnectionV1 };
        yield return new[] { SLConnectionV2 };
    }
}